...
public class Skeleton {
    ...
    public static final String[] JOINT_NAMES = {"hip_center", "spine", "shoulder_center", "head",
    ...
    public Joint getFootLeft() {
        return joints[POSITION_FOOT_LEFT];
    }

    public Joint getFootRight() {
        return joints[POSITION_FOOT_RIGHT];
    }

    public Joint getAnkleLeft() {
        return joints[POSITION_ANKLE_LEFT];
    }

    public Joint getAnkleRight() {
        return joints[POSITION_ANKLE_RIGHT];
    }

    public Joint getKneeLeft() {
        return joints[POSITION_KNEE_LEFT];
    }

    public Joint getKneeRight() {
        return joints[POSITION_KNEE_RIGHT];
    }

    public Joint getHipLeft() {
        return joints[POSITION_HIP_LEFT];
    }

    public Joint getHipRight() {
        return joints[POSITION_HIP_RIGHT];
    }

    public Joint getHipCenter() {
        return joints[POSITION_HIP_CENTER];
    }

    public Joint getHandLeft() {
        return joints[POSITION_HAND_LEFT];
    }

    public Joint getHandRight() {
        return joints[POSITION_HAND_RIGHT];
    }

    public Joint getWristLeft() {
        return joints[POSITION_WRIST_LEFT];
    }

    public Joint getWristRight() {
        return joints[POSITION_WRIST_RIGHT];
    }

    public Joint getElbowLeft() {
        return joints[POSITION_ELBOW_LEFT];
    }

    public Joint getElbowRight() {
        return joints[POSITION_ELBOW_RIGHT];
    }

    public Joint getShoulderLeft() {
        return joints[POSITION_SHOULDER_LEFT];
    }

    public Joint getShoulderRight() {
        return joints[POSITION_SHOULDER_RIGHT];
    }

    public Joint getShoulderCenter() {
        return joints[POSITION_SHOULDER_CENTER];
    }

    public Joint getHead() {
        return joints[POSITION_HEAD];
    }

    public Joint getSpine() {
        return joints[POSITION_SPINE];
    }
